...
export const metadata: Metadata = {
  ...
  description:
    "Global Sustainability Innovation Competition (GSIC) is a Prominent platform dedicated to fostering and recognizing innovators who are at the forefront of creating impactful solutions for sustainability.",
};
